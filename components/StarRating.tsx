    ...
    <div className="flex items-center">
      ...
      {halfStar && (
        <svg className="w-5 h-5 text-yellow-400" fill="currentColor" viewBox="0 0 20 20">
          ...
          <path d="M10 4.155v11.69l-2.8 2.034c-.784.57-1.838-.197-1.539-1.118l1.07-3.292a1 1 0 00-.364-1.118L2.98 8.72c-.783-.57-.38-1.81.588-1.81h3.461a1 1 0 00.951-.69l1.07-3.292c.15-.46.801-.46.95 0z" fill="#FDE68A"/>
        </svg>
      )}
